...
import Rusak from "../../../assets/rusak1.jpg";
      ...
      <section className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            ...
            <motion.p variants={SlideUp(0.4)} initial="initial" whileInView="animate" className="text-gray-700 text-sm leading-7">
            ...
            <motion.button variants={SlideUp(0.6)} initial="initial" whileInView="animate" className="primary-btn">
              Contact Us
            </motion.button>
          </div>
          <div className="flex flex-col justify-center">
            <motion.img initial={{ x: 100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }} src={Rusak} alt="" className="w-[95%] md:w-full mx-auto" />
          </div>
        </div>
      </section>
    </>
      ...
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            ...
            <motion.div variants={SlideUp(0.6)} initial="initial" whileInView="animate" className="flex gap-3">
          ...
          {/* image section */}
          <div className="flex flex-col justify-center  ">
            <motion.img initial={{ x: 100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }} src={Banner1} alt="" className="w-[95%] md:w-full mx-auto" />
          </div>
        </div>
      </div>
    </div>
